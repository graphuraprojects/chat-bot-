...
class EncryptionService:
    ...
    def decrypt(cls, encrypted_text: str, request=None, admin_user=None) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Decryption failed (Base64 decoding error): {e}. Encrypted text: {encrypted_text[:100]}...")
            ...
            logger.error(f"Decryption failed (Invalid Fernet token - incorrect padding or key): {e}. Encrypted text: {encrypted_text[:100]}...")
            ...
            logger.error(f"Decryption failed (General error): {e}. Encrypted text: {encrypted_text[:100]}...")
