...
class FAQVectorizer(FAQVectorizerInterface):
    ...
    def generate_embeddings(self, text: str) -> np.ndarray:
        ...
        Raises:
            FAQVectorizerError: If embedding generation fails
        """
        try:
            return self.embedding_generator.gemini_service.generate_embedding(
    ...
    def _validate_embedding(self, embedding: np.ndarray) -> bool:
        ...
        """
        return self.embedding_generator.gemini_service.validate_embedding(embedding)
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            embedding_health = self.embedding_generator.gemini_service.health_check()
