...
Response:"""
        ...
        try:
            ...
            if not retrieved_faqs:
                ...
                if len(retrieved_faqs) == 1:
                    return self._generate_single_match_response_ai(query, retrieved_faqs[0], user_tone, style_characteristics)
                else:
                    return self._generate_multi_source_response_ai(query, retrieved_faqs, user_tone, style_characteristics)
    ...
    def _create_enhanced_synthesis_prompt(self, faqs: List[FAQEntry], analysis: Dict[str, Any]) -> str:
        ...
        base_template = self.prompt_templates['multi_source_synthesis']
...
Create a synthesized response that combines all relevant information into a coherent, comprehensive answer:"""
    ...
    def generate_contextual_response(self, query: str, retrieved_faqs: List[FAQEntry], 
                                   context: Optional[ConversationContext] = None) -> Response:
        """
        ...
        try:
            ...
            prompt = self.prompt_templates['context_aware_response'].format(
    ...
    def _generate_single_match_response_ai(self, query: str, faq: FAQEntry, 
                                         user_tone: str, style_characteristics: Dict[str, Any]) -> Response:
        ...
        try:
            ...
            # Create contextual prompt
            prompt = self.prompt_templates['contextual_response'].format(
                query=query,
                tone=user_tone,
